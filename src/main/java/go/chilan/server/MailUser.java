...
public static void createConfirmationMail(String mail, String confirmation) throws MessagingException {
	...
	{
		String content="<html>Welcome by ChilanGo! </br> Confirm your mail here: <a href=\"http://"+Constants.SERVER_IP+":"+Constants.PORT_MAIL_CHECK+"/"+confirmation+"\">click me</a> </br> if the link does not work copy following into your brwoser: http://"+Constants.SERVER_IP+":8090/"+confirmation+"</html>";
